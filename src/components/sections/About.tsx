			...
			<div className="md:flex">
				<div className="text-gray text-md py-4">
					<p>
						...
						{new Date().getFullYear() - new Date("2007-05-01").getFullYear()} years old and
						Interested in computer science. I started programming by taking{" "}
						<a href="https://tinyurl.com/2kdaobma" target="_blank" className="">
							CS50
						</a>{" "}
						course from harvard in 2020 when I decided to learn how to code and make stuff out of
						the box.
					</p>
					<br />
					<p>
						In 2021, I started to think about the internet and how it works, so I focused on web
						development (especially front-end) and doing my best here.
					</p>
					<br />
				...
				<div className="flex justify-center items-center px-8 group">
					<div className="relative w-60 h-60 mr-4">
						<Image src="/logo.webp" fill className="rounded-lg" alt="mcdanang" />
					</div>
